...
def geturl(threadName, q):
    ...
    re_token = re.search(r'v4/answers/(.*?)/voters',url)
    ...
    try:           
        ...
        db.answer_voters.insert_one(decodejson)
...
for url_token in answer_list:
    ...
    url2 ='/voters?include=data%5B%2A%5D.answer_count%2Carticles_count%2Cfollower_count%2Cgender%2Cis_followed%2Cis_following%2Cbadge%5B%3F%28type%3Dbest_answerer%29%5D.topics&limit=10&offset=0'
